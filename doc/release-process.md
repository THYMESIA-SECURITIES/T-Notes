...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://github.com/T_Notes-Project/T_Notes/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://github.com/t_notes-project/t_notes/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/t_notes-project/gitian.sigs.git
    git clone https://github.com/t_notes-project/t_notes-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/t_notes-project/t_notes.git
...
- Detached signatures will then be committed to the [t_notes-detached-sigs](https://github.com/t_notes-Project/t_notes-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/T_Notes-Project/T_Notes/releases/new) with a link to the archived release notes.
