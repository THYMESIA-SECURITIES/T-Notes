...
The script [extract-osx-sdk.sh](https://github.com/t_notes-project/t_notes/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/t_notes-project/t_notes/blob/master/doc/README_osx.md) for troubleshooting tips.
