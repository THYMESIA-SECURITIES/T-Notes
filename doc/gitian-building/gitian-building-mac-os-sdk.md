...
The script [extract-osx-sdk.sh](https://github.com/THYMESIA-SECURITIES/T-Notes/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
t_notes/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/THYMESIA-SECURITIES/T-Notes/blob/master/doc/README_osx.md) for troubleshooting tips.
