...
This document provides guidelines for internationalization of the T-Notes software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to T_Notes network</source>
        <translation>
            <numerusform>%n active connection to T_Notes network</numerusform>
            <numerusform>%n active connections to T_Notes network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `t_notes_en.ts` remains unchanged.
