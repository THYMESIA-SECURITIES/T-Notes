...
RESOURCES += src/qt/t_notes.qrc src/qt/t_notes_locale.qrc

TRANSLATIONS += src/qt/locale/t_notes_bg.ts \
                src/qt/locale/t_notes_de.ts \
                src/qt/locale/t_notes_en.ts \
                src/qt/locale/t_notes_es.ts \
                src/qt/locale/t_notes_fi.ts \
                src/qt/locale/t_notes_fr.ts \
                src/qt/locale/t_notes_it.ts \
                src/qt/locale/t_notes_ja.ts \
                src/qt/locale/t_notes_pl.ts \
                src/qt/locale/t_notes_pt.ts \
                src/qt/locale/t_notes_ru.ts \
                src/qt/locale/t_notes_sk.ts \
                src/qt/locale/t_notes_sv.ts \
                src/qt/locale/t_notes_vi.ts \
                src/qt/locale/t_notes_zh_CN.ts \
                src/qt/locale/t_notes_zh_TW.ts
