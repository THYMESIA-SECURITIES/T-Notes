...
def main():
    ...
    # Filter out hosts with multiple t_notes ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple t_notes ports' % (ip_stats(ips)), file=sys.stderr)
