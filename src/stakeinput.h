...
#ifndef T_Notes_STAKEINPUT_H
#define T_Notes_STAKEINPUT_H
...
class CTncStake : public CStakeInput
{
private:
...
public:
    CTncStake(const CTxOut& _from, const COutPoint& _outPointFrom, const CBlockIndex* _pindexFrom) :
            CStakeInput(_pindexFrom), outputFrom(_from), outpointFrom(_outPointFrom) {}

    static CTncStake* NewTncStake(const CTxIn& txin);
