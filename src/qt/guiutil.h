...
/** Utility functions used by the T_Notes Qt UI.
 */
namespace GUIUtil
{
...
// Render T_Notes addresses in monospace font
...
// Parse "t_notes:" URI into recipient object, return true on successful parsing
