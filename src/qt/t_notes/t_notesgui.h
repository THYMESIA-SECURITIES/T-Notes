...
#include "qt/t_notes/navmenuwidget.h"
#include "qt/t_notes/topbar.h"
#include "qt/t_notes/dashboardwidget.h"
#include "qt/t_notes/send.h"
#include "qt/t_notes/receivewidget.h"
#include "qt/t_notes/addresseswidget.h"
#include "qt/t_notes/coldstakingwidget.h"
#include "qt/t_notes/masternodeswidget.h"
#include "qt/t_notes/snackbar.h"
#include "qt/t_notes/settings/settingswidget.h"
...
/**
  T_Notes GUI main class. This class represents the main window of the T_Notes UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class T_NotesGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit T_NotesGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~T_NotesGUI();
