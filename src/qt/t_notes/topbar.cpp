...
#include "qt/t_notes/topbar.h"
#include "qt/t_notes/forms/ui_topbar.h"
#include "qt/t_notes/lockunlock.h"
#include "qt/t_notes/qtutils.h"
#include "qt/t_notes/receivedialog.h"
#include "qt/t_notes/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/t_notes/balancebubble.h"
...
TopBar::TopBar(T_NotesGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopTnc, ui->labelAmountTopShieldedTnc}, "amount-small-topbar");
    setCssProperty({ui->labelAmountTnc}, "amount-topbar");
    setCssProperty({ui->labelPendingTnc, ui->labelImmatureTnc}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("T_Notes")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // TNC Total
    QString totalTnc = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // TNC
    // Top
    ui->labelAmountTopTnc->setText(totalTransparent);
    ui->labelAmountTopShieldedTnc->setText(totalShielded);
    // Expanded
    ui->labelAmountTnc->setText(totalTnc);
    ui->labelPendingTnc->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureTnc->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
