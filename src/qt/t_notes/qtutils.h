...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, T_NotesGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, T_NotesGUI* gui, double posX = 3);
