...
#include "qt/t_notes/forms/ui_coldstakingwidget.h"
#include "qt/t_notes/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/t_notes/requestdialog.h"
...
ColdStakingWidget::ColdStakingWidget(T_NotesGUI* parent) :
    PWidget(parent),
