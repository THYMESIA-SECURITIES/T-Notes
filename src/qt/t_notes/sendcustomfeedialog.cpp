...
#include "qt/t_notes/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(T_NotesGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &T_NotesGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
