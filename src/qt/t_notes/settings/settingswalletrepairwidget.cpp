...
#include "qt/t_notes/settings/settingswalletrepairwidget.h"
#include "qt/t_notes/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/t_notes/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(T_NotesGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to T_NotesGUI::handleRestart()
