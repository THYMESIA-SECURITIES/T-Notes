...
#include "qt/t_notes/settings/settingsdisplayoptionswidget.h"
#include "qt/t_notes/settings/forms/ui_settingsdisplayoptionswidget.h"
#include <QListView>
#include <QSettings>
#include <QDir>
#include "guiutil.h"
...
SettingsDisplayOptionsWidget::SettingsDisplayOptionsWidget(T_NotesGUI* _window, QWidget *parent) :
