...
#include "qt/t_notes/settings/settingsbackupwallet.h"

#include "qt/t_notes/settings/forms/ui_settingsbackupwallet.h"
...
SettingsBackupWallet::SettingsBackupWallet(T_NotesGUI* _window, QWidget *parent) :
