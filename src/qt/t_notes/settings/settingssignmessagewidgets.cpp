...
#include "qt/t_notes/settings/settingssignmessagewidgets.h"
#include "qt/t_notes/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(T_NotesGUI* _window, QWidget *parent) :
