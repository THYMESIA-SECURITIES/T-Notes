...
#include "qt/t_notes/settings/settingsmultisendwidget.h"
#include "addresstablemodel.h"
#include "base58.h"
#include "init.h"
#include "qt/t_notes/qtutils.h"
#include "qt/t_notes/settings/forms/ui_settingsmultisendwidget.h"
#include "qt/t_notes/settings/settingsmultisenddialog.h"
                                                                    ...
                                                                    ui(new Ui::SettingsMultisendWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other T-Notes addresses after it matures."));
