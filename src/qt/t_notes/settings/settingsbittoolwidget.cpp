...
#include "qt/t_notes/settings/settingsbittoolwidget.h"
#include "qt/t_notes/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(T_NotesGUI* _window, QWidget *parent) :
