...
#include "qt/t_notes/settings/settingsexportcsv.h"
#include "csvmodelwriter.h"
#include "guiinterface.h"
#include "guiutil.h"
#include "optionsmodel.h"
#include "qt/t_notes/qtutils.h"
#include "qt/t_notes/settings/forms/ui_settingsexportcsv.h"
#include <QFile>

SettingsExportCSV::SettingsExportCSV(T_NotesGUI* _window, QWidget* parent) : PWidget(_window, parent),
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
        ...
        isTxExport ? tr("T_Notes_tx_csv_export(*.csv)") : tr("T_Notes_addresses_csv_export(*.csv)"),
        nullptr);
