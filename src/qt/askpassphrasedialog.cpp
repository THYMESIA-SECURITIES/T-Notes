...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            T_NotesGUI* window = static_cast<T_NotesGUI*>(parentWidget());
...
{
    T_NotesGUI* gui = static_cast<T_NotesGUI*>(parentWidget());
...
{
    hide();
    static_cast<T_NotesGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("T-Notes will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your TNCs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
