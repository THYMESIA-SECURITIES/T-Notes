...
/* t_notes GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "T_Notes"
#define QAPP_ORG_DOMAIN "t_notes.org"
#define QAPP_APP_NAME_DEFAULT "T_Notes-Qt"
#define QAPP_APP_NAME_TESTNET "T_Notes-Qt-testnet"
