...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help") || gArgs.IsArgSet("-version")) {
        std::string strUsage = _("T-Notes RPC client version") + " " + FormatFullVersion() + "\n";
        if (!gArgs.IsArgSet("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  t_notes-cli [options] <command> [params]  " + _("Send command to T-Notes") + "\n" +
                        "  t_notes-cli [options] help                " + _("List commands") + "\n" +
                        "  t_notes-cli [options] help <command>      " + _("Get help for a command") + "\n";
