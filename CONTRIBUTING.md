Contributing to T-Notes
============================

The T-Notes project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/THYMESIA-SECURITIES/T-Notes/blob/master/doc/translation_process.md)
...
The following applies to code changes to the T-Notes project, and is not to be
confused with overall T_Notes Network Protocol consensus changes.

Whether a pull request is merged into T-Notes rests with the project merge
...
Patches that change T_Notes consensus rules are considerably more involved than
...
Where a patchset proposes to change the T_Notes consensus, it must have been
...
The project leader is the release manager for each T-Notes release.
