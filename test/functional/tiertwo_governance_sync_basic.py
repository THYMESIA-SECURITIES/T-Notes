...
from test_framework.test_framework import t_notesTier2TestFramework
...
class MasternodeGovernanceBasicTest(t_notesTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.t_notes.org/t/test-proposal"
