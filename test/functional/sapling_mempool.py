#!/usr/bin/env python3
# Copyright (c) 2020 The T-Notes developers
...
class SaplingMempoolTest(t_notesTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 TNC note to Alice
        ...
        # miner sends another 10 TNC note to Alice
