...
class BlockIndexStatsTest(t_notesTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 TNC "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 TNC + 9 notes of 5 TNC + 1 note of 4 TNC (using 1.0 fee)
