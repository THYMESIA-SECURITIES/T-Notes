...
class BudgetProposalTest(t_notesTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid T_Notes address")
        assert_raises_rpc_error(-5, "Invalid T_Notes address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of %.8f is less than minimum 10 TNC allowed" % invalid_amt, self.nodes[0].preparebudget,
