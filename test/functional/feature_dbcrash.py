...
from test_framework.test_framework import t_notesTestFramework
...
class ChainstateWriteCrashTest(t_notesTestFramework):
    ...
    def set_test_params(self):
        ...
        self.chain_params = ['-nuparams=v5_shield:90000', '-nuparams=T_Notes_v4.0:90000',
                             '-nuparams=T_Notes_v3.4:90000',
    ...
    def restart_node(self, node_index, expected_tip):
        ...
        while time.time() - time_start < 120:
            try:
                ...
                # If t_notesd exits, then try again.  wait_for_node_exit()
                # should raise an exception if t_notesd doesn't exit.
                self.wait_for_node_exit(node_index, timeout=10)
            self.crashed_on_restart += 1
            time.sleep(1)

        # If we got here, t_notesd isn't coming back up on restart.  Could be a
        # bug in t_notesd, or we've gotten unlucky with our dbcrash ratio --
