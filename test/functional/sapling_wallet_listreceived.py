...
class ListReceivedTest (t_notesTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 TNC.
        ...
        # Send 1 TNC to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 TNC sending them all (fee is 0.1 TNC)
        ...
        # Confirm transaction (2 TNC from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 TNC, send 0.6 TNC + 0.05 TNC fee
